...
export function AuthPage() {
  ...
  const panelSubtitle =
    mode === 'admin'
      ...
      : 'Conecte a conta C6 Bank da sua empresa (principal), ou Asaas / Banco Inter, e comece a fazer repasses em lote.';
        ...
        <section className="flex flex-col justify-between rounded-[36px] border border-white/10 bg-white/5 p-8 shadow-[0_40px_120px_rgba(2,6,23,0.55)] lg:p-12">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
              Multiempresa, conexão C6 Bank (principal) + Asaas ou Banco Inter individual por
              cliente, pagamento unitário e em lote, execução segura via API e histórico completo.
              Cada empresa usa a própria conta bancária.
            </p>
          </div>
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {[
              ...
              ['Conta própria', 'A execução acontece diretamente na conta C6 Bank, Asaas ou Inter do cliente.'],
